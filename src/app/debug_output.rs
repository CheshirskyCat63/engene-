...
fn print_entity_summary(ecs: &Ecs, e: u64) {
    ...
    let goal = match ecs.ai_states.get(&e) {
    ...
    println!(
        ...
        name, species, goal, emo_str,
        hp * 100.0, hunger * 100.0, money,
        age_str, mem_count, relations, has_plan,
    );
}
