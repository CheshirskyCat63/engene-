...
impl IdentityRegistry {
    ...
    pub fn register_new(&mut self, entity: Entity) -> PersistentEntityId {
        ...
        self.persistent_to_presence.insert(pid, EntityPresence::Live(entity));
    ...
    pub fn mark_unloaded(&mut self, pid: PersistentEntityId) {
        ...
        self.persistent_to_presence.insert(pid, EntityPresence::Unloaded);
    }
    ...
    pub fn mark_dead(&mut self, pid: PersistentEntityId, current_tick: u64) {
        ...
        self.persistent_to_presence.insert(pid, EntityPresence::Dead);
    ...
    pub fn presence(&self, pid: PersistentEntityId) -> EntityPresence {
        self.persistent_to_presence.get(&pid).copied().unwrap_or(EntityPresence::Dead)
    }
    ...
    pub fn gc_tombstones(&mut self, current_tick: u64, max_age: u64) {
        let expired: Vec<PersistentEntityId> = self.tombstone_tick.iter()
