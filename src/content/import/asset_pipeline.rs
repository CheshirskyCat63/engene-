...
use super::hashes::{AssetVersion, hash_file_contents, hash_import_settings};
...
impl ImportPipeline {
    ...
    pub fn register_source(&mut self, path: &Path, asset_type: AssetType, settings: &str) -> AssetId {
    ...
    pub fn needs_reimport(&self, asset: AssetId) -> bool {
        ...
        record.version.needs_reimport(current_source, record.version.settings_hash)
    }
    ...
    pub fn parallel_batch_size(&self) -> usize {
        ...
        if self.worker_count == 0 { return total; }
