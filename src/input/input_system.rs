...
impl InputActionSystem {
    ...
    fn default_bindings() -> Vec<ActionBinding> {
        vec![
            ActionBinding {
                action: GameAction::MoveForward,
                primary: "KeyW".into(),
                secondary: None,
            },
            ActionBinding {
                action: GameAction::MoveBack,
                primary: "KeyS".into(),
                secondary: None,
            },
            ActionBinding {
            ...
            ActionBinding {
                action: GameAction::QuickSave,
                primary: "F5".into(),
                secondary: None,
            },
            ActionBinding {
                action: GameAction::QuickLoad,
                primary: "F9".into(),
                secondary: None,
            },
            ActionBinding {
...
impl EngineSystem for InputActionSystem {
    ...
    fn descriptor(&self) -> SystemDescriptor {
        SystemDescriptor::new("InputActionSystem").with_parallel(true)
    }
