//! ENGENE SDK Binary — full editor with GUI, scene/world editor, chunk authoring,
//! prefab browser, inspector, overlays, doctor, event monitor, content validation,
//! runtime truth dashboard, replay browser, and performance dashboards.
        ...
        match event {
            ...
            WindowEvent::RedrawRequested => {
                ...
                if let Some(r) = self.renderer.as_mut() {
                    ...
                    let telemetry = engene::core::perf::telemetry::Telemetry::new();
