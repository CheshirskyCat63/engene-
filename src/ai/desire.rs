use crate::ai::body;
use crate::ai::emotions::DominantEmotion;
use crate::ai::memory::{LessonAction, LessonContext};
use crate::ai::thresholds::Thresholds;
...
fn hunt_confidence_npc(mem: Option<&crate::ai::memory::Memory>, traits: &NpcTraits) -> f32 {
...
fn hunt_confidence_monster(mem: Option<&crate::ai::memory::Memory>, traits: &MonsterTraits) -> f32 {
