...
impl Default for ContentPipelineConfig {
    fn default() -> Self {
        Self {
            source_dirs: vec![PathBuf::from("assets"), PathBuf::from("game/data")],
...
impl ContentPipeline {
    ...
    pub fn init(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            "[ContentPipeline] Initialized with {} source dirs",
    ...
    fn import_phase(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            "[ContentPipeline] Imported {} assets",
            self.import_state.imported_count
        );
        Ok(())
    }
    ...
    fn cook_phase(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            "[ContentPipeline] Cooked {} assets",
            self.cooking_state.cooked_count
        );
        Ok(())
    }
    ...
    fn validation_phase(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        use crate::schema_governance::{ContentValidator, SchemaRegistry};
